...
class ForgotPasswordCustomElevatedBtn extends CustomState{
  final GestureTapCallback onPressed;
  final Color bgColor;
  final String text;


   const ForgotPasswordCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor, required this.text});
