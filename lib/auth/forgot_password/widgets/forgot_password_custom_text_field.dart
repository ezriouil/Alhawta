...
class ForgotPasswordCustomTextField extends CustomState{
  ...
  final Widget? trailing;
   ...
   const ForgotPasswordCustomTextField({super.key, required this.controller, required this.hint, required this.icon, required this.validator, this.keyboardType = TextInputType.text, this.obscureText = false, this.trailing});
