...
class RegisterCustomElevatedBtn extends CustomState{
  final GestureTapCallback onPressed;
  final Color bgColor;
  final String text;


   const RegisterCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor, required this.text});
