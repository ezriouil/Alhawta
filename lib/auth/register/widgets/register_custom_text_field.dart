...
class RegisterCustomTextField extends CustomState{
  ...
  final Widget? trailing;
   ...
   const RegisterCustomTextField({super.key, required this.controller, required this.hint, required this.icon, required this.validator, this.keyboardType = TextInputType.text, this.obscureText = false, this.trailing});
