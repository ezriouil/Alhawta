...
class RegisterCustomTextIconBtn extends CustomState{
  final GestureTapCallback onPressed;
  final Color bgColor;
  final String icon, text;


   const RegisterCustomTextIconBtn({super.key, required this.onPressed, required this.bgColor, required this.text, required this.icon});
