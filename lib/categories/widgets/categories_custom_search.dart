...
class CategoriesCustomSearch extends CustomState{
  final TextEditingController controller;
  final Function(String?) onChange;
  final String hint;


   const CategoriesCustomSearch({super.key, required this.controller, required this.hint, required this.onChange});
  ...
  Widget execute(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          filled: true,
          hintText: hint,
          contentPadding: const EdgeInsets.all(CustomSizes.SPACE_BETWEEN_ITEMS / 2),
