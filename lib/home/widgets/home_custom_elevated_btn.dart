...
class HomeCustomElevatedBtn extends CustomState{
  ...
  final String text;
   ...
   const HomeCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor, this.textColor, required this.text});
