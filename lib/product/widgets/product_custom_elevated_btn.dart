...
class ProductCustomElevatedBtn extends CustomState{
  ...
  final String text;
   ...
   const ProductCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor,required this.textColor, required this.text});
