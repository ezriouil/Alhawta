          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                    ...
                    subTitle: "Enable notifications to inform you by the new products.",
                    icon: Iconsax.notification, onClick: () {  },
                    trailing: Switch(
                      value: controller.switchBtnEnableNotifications.value,
                      onChanged: controller.onEnableNotifications,
                      activeColor: greenColor(context),
                    )
                ),
              ),
              ...
              SettingsCustomTile(
                  ...
                  subTitle: "Pick your language prefer.",
              ...
              Text("Account", style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontFamily: "Pop_Bold", letterSpacing: 0)),
