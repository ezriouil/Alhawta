...
class SettingsCustomElevatedBtn extends CustomState{
  ...
  final String text;
   ...
   const SettingsCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor, this.textColor, required this.text});
