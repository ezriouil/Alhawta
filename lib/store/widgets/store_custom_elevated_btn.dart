...
class StoreCustomElevatedBtn extends CustomState{
  ...
  final String text;
   ...
   const StoreCustomElevatedBtn({super.key, required this.onPressed, required this.bgColor, this.textColor, required this.text});
