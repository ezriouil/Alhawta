...
class StoreCustomTextField extends CustomState{
  ...
  final String? Function(String? value)? validator;
   ...
   const StoreCustomTextField({super.key, required this.controller, required this.hint, this.icon, required this.validator, this.minMaxLines, this.maxLength, this.keyboardType});
