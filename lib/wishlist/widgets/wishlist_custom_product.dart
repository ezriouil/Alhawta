...
class WishListCustomProduct extends CustomState {
  ...
  const WishListCustomProduct({super.key, required this.imgUri, required this.id,  required this.title, required this.description, required this.onView, required this.onDelete});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: CustomSizes.SPACE_BETWEEN_ITEMS / 2),
                      WishListCustomBtn(onPressed: (){ onView(id); }, bgColor: greenColor(context), title: "View")
                    ],
                  ),
                ],
              ),
